...
function assertFhevmStoredPublicKey(
  ...
  if (typeof (value as FhevmStoredPublicKey).publicKeyId !== "string") {
  ...
  if (!((value as FhevmStoredPublicKey).publicKey instanceof Uint8Array)) {
...
function assertFhevmStoredPublicParams(
  ...
  if (typeof (value as FhevmStoredPublicParams).publicParamsId !== "string") {
  ...
  if (!((value as FhevmStoredPublicParams).publicParams instanceof Uint8Array)) {
    throw new Error(
